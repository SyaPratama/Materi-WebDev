...
<?php if(isset($_SESSION['add-post-success'])) : // show if add category  waas success ?>
...
<?php elseif(isset($_SESSION['edit-post-success'])) : // show if add category  waas success ?>
<div class="alert-message success container">
    <p>
...
<?php elseif(isset($_SESSION['edit-post'])) : // show if add category  waas success ?>
...
<?php elseif(isset($_SESSION['delete-post-success'])) : // show if add category  waas success ?>
<div class="alert-message success container">
    <p>
      ...
      <button id="hide-sidebar-btn" class="sidebar-toggle"><i class="uil uil-angle-double-left"></i></button>
        <aside>
            <ul>
                ...
                <li>
                    <a href="index.php"  class="active"><i class="uil uil-file-search-alt"></i>
                        <h5>Manage Post</h5>
                    </a>
                </li>
