...
//make sure edit post btn was click 
if(isset($_POST['submit'])) {
    ...
    // set is_featured to 0 if checked
    ...
    if(!$title) {
        ...
        if($thumbnail['name']) {
            ...
            // Rename image
            $time = time(); // make each image name upload unique using timestamp
            ...
            if(in_array($extension, $allowed_files)) {      
                ...
                $_SESSION['edit-post'] = "Couldn't update post. Thumbnail should be png, jpg , jpeg or webp";
            }
        }
    }
